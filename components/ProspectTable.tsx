...
export const ProspectTable: React.FC<Props> = ({ prospects, onCall, onUpload }) => {
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-slate-700">
            {prospects.map((prospect) => (
              <tr key={prospect.id} className="hover:bg-blue-50/50 dark:hover:bg-blue-900/10 transition duration-150 group">
                <td className="p-4">
